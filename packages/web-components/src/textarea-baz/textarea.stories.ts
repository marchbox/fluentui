...
const storyTemplate = html<StoryArgs<FluentTextArea>>`
  <fluent-textarea-baz
    ...
    resize="${x => x.resize}"
    value="${x => x.value}"
    >${x => x.content ?? ''}</fluent-textarea-baz
  >
`;

export default {
  title: 'Components/TextArea Baz',
  argTypes: {
    appearance: {
...
export const Appearance: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <div>
    ...
    <div style="padding: 1rem; width: fit-content;">
      <fluent-textarea-baz></fluent-textarea-baz>
    </div>
    <p>Filled darker</p>
    <div style="padding: 1rem; width: fit-content; background-color: #fff;">
      <fluent-textarea-baz appearance="filled-darker"></fluent-textarea-baz>
    </div>
    <p>Filled darker with shadow</p>
    <div style="padding: 1rem; width: fit-content; background-color: #fff;">
      <fluent-textarea-baz appearance="filled-darker" display-shadow></fluent-textarea-baz>
    </div>
    <p>Filled lighter</p>
    <div style="padding: 1rem; width: fit-content; background-color: #f5f5f5;">
      <fluent-textarea-baz appearance="filled-lighter"></fluent-textarea-baz>
    </div>
    <p>Filled lighter with shadow</p>
    <div style="padding: 1rem; width: fit-content; background-color: #f5f5f5;">
      <fluent-textarea-baz appearance="filled-lighter" display-shadow></fluent-textarea-baz>
    </div>
  </div>
`);
...
export const Block: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    ...
    <div>
      <p>Block</p>
      <fluent-textarea-baz block></fluent-textarea-baz>
    </div>
  </div>
`);
...
export const Size: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    ...
    <div>
      <p>Small</p>
      <fluent-textarea-baz size="small"></fluent-textarea-baz>
    </div>
    <div>
      <p>Large</p>
      <fluent-textarea-baz size="large"></fluent-textarea-baz>
    </div>
  </div>
`);

export const AutoResize: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <fluent-textarea-baz auto-resize></fluent-textarea-baz>
`);
...
export const Resize: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    <div>
      <p>None (default)</p>
      <fluent-textarea-baz resize="none"></fluent-textarea-baz>
    </div>
    <div>
      <p>Horizontal</p>
      <fluent-textarea-baz resize="horizontal"></fluent-textarea-baz>
    </div>
    <div>
      <p>Vertical</p>
      <fluent-textarea-baz resize="vertical"></fluent-textarea-baz>
    </div>
    <div>
      <p>Both</p>
      <fluent-textarea-baz resize="both"></fluent-textarea-baz>
    </div>
  </div>
`);
...
export const Required: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <form id="required-form" action="#">
    <fluent-field>
      ...
      <fluent-textarea-baz slot="input" name="required-input" required></fluent-textarea-baz>
    </fluent-field>
...
export const WithHTMLCode: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <fluent-textarea-baz style="inline-size: 300px; min-block-size: 200px;" auto-resize resize="both" size="large">
