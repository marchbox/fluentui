...
const storyTemplate = html<StoryArgs<FluentTextArea>>`
  <fluent-textarea-foo
    ...
    resize="${x => x.resize}"
    value="${x => x.value}"
    >${x => x.content ?? ''}</fluent-textarea-foo
  >
`;

export default {
  title: 'Components/TextArea Foo',
  argTypes: {
    appearance: {
...
export const Appearance: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <div>
    ...
    <div style="padding: 1rem; width: fit-content;">
      <fluent-textarea-foo></fluent-textarea-foo>
    </div>
    <p>Filled darker</p>
    <div style="padding: 1rem; width: fit-content; background-color: #fff;">
      <fluent-textarea-foo appearance="filled-darker"></fluent-textarea-foo>
    </div>
    <p>Filled darker with shadow</p>
    <div style="padding: 1rem; width: fit-content; background-color: #fff;">
      <fluent-textarea-foo appearance="filled-darker" display-shadow></fluent-textarea-foo>
    </div>
    <p>Filled lighter</p>
    <div style="padding: 1rem; width: fit-content; background-color: #f5f5f5;">
      <fluent-textarea-foo appearance="filled-lighter"></fluent-textarea-foo>
    </div>
    <p>Filled lighter with shadow</p>
    <div style="padding: 1rem; width: fit-content; background-color: #f5f5f5;">
      <fluent-textarea-foo appearance="filled-lighter" display-shadow></fluent-textarea-foo>
    </div>
  </div>
`);
...
export const Block: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    ...
    <div>
      <p>Block</p>
      <fluent-textarea-foo block></fluent-textarea-foo>
    </div>
  </div>
`);
...
export const Size: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    ...
    <div>
      <p>Small</p>
      <fluent-textarea-foo size="small"></fluent-textarea-foo>
    </div>
    <div>
      <p>Large</p>
      <fluent-textarea-foo size="large"></fluent-textarea-foo>
    </div>
  </div>
`);

export const AutoResize: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <fluent-textarea-foo auto-resize></fluent-textarea-foo>
`);
...
export const Resize: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <div style="display: flex; flex-direction: column; gap: 1rem;">
    <div>
      <p>None (default)</p>
      <fluent-textarea-foo resize="none"></fluent-textarea-foo>
    </div>
    <div>
      <p>Horizontal</p>
      <fluent-textarea-foo resize="horizontal"></fluent-textarea-foo>
    </div>
    <div>
      <p>Vertical</p>
      <fluent-textarea-foo resize="vertical"></fluent-textarea-foo>
    </div>
    <div>
      <p>Both</p>
      <fluent-textarea-foo resize="both"></fluent-textarea-foo>
    </div>
  </div>
`);
...
export const Required: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <form id="required-form" action="#">
    <fluent-field>
      ...
      <fluent-textarea-foo slot="input" name="required-input" required></fluent-textarea-foo>
    </fluent-field>
...
export const WithHTMLCode: Story<FluentTextArea> = renderComponent(html<StoryArgs<FluentTextArea>>`
  <fluent-textarea-foo style="inline-size: 300px; min-block-size: 200px;" auto-resize resize="both" size="large">
